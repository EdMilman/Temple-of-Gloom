...
public class Node {
  ...
  /**
   * The unique numerical identifier of this Vertex
   */
  private final long id;
  /**
   * Represents the edges outgoing from this Vertex
   */
  ...
  /**
   * Returns the ExitEdge of this Vertex that connects to q.
  ...
  public Edge getEdge(Node q) {
    ...
    throw new IllegalArgumentException("getEdge: Vertex must be a neighbour of this Vertex");
  }

  /**
   * Return an unmodifiable set of Edges leaving this Vertex.
   */
  ...
  /**
   * Return an unmodifiable set Nodes neighbouring this Vertex.
   */
  ...
  /**
   * Return the Tile corresponding to this Vertex.
   */
  public Tile getTile() {
    return tile;
  }
  ...
  /**
   * Return truee if ob is a Vertex with the same id as this one.
   */
  @Override
